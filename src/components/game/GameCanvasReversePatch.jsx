...
// 6. In block collision (line 1620), change raygun to photon and add tier 10 reverse invul destruction:
...
// 7. Change all raygun references to photon throughout the file
